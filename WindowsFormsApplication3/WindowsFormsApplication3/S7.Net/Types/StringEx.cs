...
namespace PlcCommon.S7.Net.Types
{
    ...
    public static class StringEx
    {
        ...
        {
            if (reservedLength > byte.MaxValue)
            {
                Logger.E($"The maximum string length supported is {byte.MaxValue}.");
                //throw new ArgumentException($"The maximum string length supported is {byte.MaxValue}.");
            }
